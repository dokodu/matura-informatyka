...
public class Matura2016 {
	...
	public static void main(String[] args) throws Exception {
		...
		try (BufferedReader br = new BufferedReader(new FileReader("egzaminy/2016/Dane_PR2/?.txt"))) {
			try (FileWriter fw = new FileWriter("egzaminy/2016/Wyniki_PR2/?.txt", false)) { // false - zastępujemy poprzedni plik
				zadanie(br, fw);
			}
		}
	}
