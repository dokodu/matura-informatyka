...
public class Matura2017 {
	...
	public static void main(String[] args) throws Exception {
		...
		try (BufferedReader br = new BufferedReader(new FileReader("egzaminy/2017/Dane_PR2/?.txt"))) {
			try (FileWriter fw = new FileWriter("egzaminy/2017/Wyniki_PR2/?.txt", false)) { // false - zastępujemy poprzedni plik
				zadanie(br, fw);
			}
		}
	}
